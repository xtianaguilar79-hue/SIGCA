...
export default async function BeneficiosPage({
  ...
  const [{ data: beneficios }, { data: lugares }] =
    await Promise.all([
      supabase
        .from("beneficios")
        .select(
  ...
  const activos = (beneficios || []).filter(
      ...
      <section className="main-area benefits-page">
        ...
        <header className="main-head">
          <div>
            ...
            <p>
              Administrá el catálogo y registrá las
              entregas realizadas a los afiliados.
            </p>
          </div>
                    ...
                    <div>
                      ...
                      <dd>
                        {beneficio.stock === null
                          ...
                          : beneficio.stock.toLocaleString(
                              "es-AR",
                            )}
                      </dd>
                    </div>
