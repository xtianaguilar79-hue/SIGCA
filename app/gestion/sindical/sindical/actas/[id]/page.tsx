  ...
  return <main className="management minute-detail-shell">
    ...
    <section className="main-area minute-detail-page">
      ...
      <article className="minute-document">
        ...
        <dl className="minute-metadata"><div><dt>Fecha</dt><dd>{new Intl.DateTimeFormat("es-AR", { dateStyle: "long", timeStyle: "short" }).format(new Date(document.fecha))}</dd></div><div><dt>Responsable de carga</dt><dd>{creatorName}</dd></div></dl>
        <Section title="Participantes" content={document.participantes}/><Section title="Desarrollo" content={document.desarrollo}/><Section title="Acuerdos alcanzados" content={document.acuerdos}/>
    ...
    <style>{`@media print{html,body{height:auto!important;min-height:0!important;margin:0!important;overflow:visible!important}.management,.main-area,.minute-detail-page,.minute-detail-shell{height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important}.minute-document{height:auto!important;min-height:0!important;margin:0!important;page-break-after:auto!important;break-after:auto!important}.minute-document footer{margin-top:35px!important;break-inside:avoid!important;page-break-inside:avoid!important}.home-brand-link{display:none!important}}`}</style>
  </main>;
}
