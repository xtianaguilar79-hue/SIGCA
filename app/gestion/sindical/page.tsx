...
export default async function GestionSindicalPage() {
  ...
  return <main className="management">
    ...
    <section className="main-area"><header className="main-head"><div><p className="kicker">ORGANIZACIÓN Y SEGUIMIENTO</p><h1>Gestión Sindical</h1><p>Herramientas para organizar afiliaciones, actas y minutas, reclamos, visitas e inspecciones.</p></div></header>
      <div className="cards">
        ...
        <Link className="module module-link" href="/gestion/sindical/actas"><span>▧</span><h2>Actas y minutas</h2><p>Registro de reuniones, participantes, desarrollo y acuerdos en un formato claro y simple.</p><small>DISPONIBLE</small></Link>
        ...
        <Link className="module module-link" href="/gestion/sindical/visitas"><span>⌖</span><h2>Visitas e inspecciones</h2><p>Constancias de recorridas, participantes, hallazgos, acciones y registro fotográfico.</p><small>DISPONIBLE</small></Link>
      </div>
    </section>
  </main>;
}
